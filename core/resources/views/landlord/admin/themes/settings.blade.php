                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if($data->is_premium == 1)
                                            <span class="alert alert-sm alert-primary" >{{__('Yes')}}</span>
                                        @else
                                            <span class="alert alert-sm alert-info" >{{__('No')}}</span>
                                         @endif
                                    </td>
                                    <td>
                                        @php
                ...
                <div class="modal-content">
                    ...
                    <form action="#" id="testimonial_edit_modal_form" method="post"
                        ...
                        <div class="modal-body">
                            ...
                            <x-fields.select name="is_premium" title="{{__('Is Premium')}}" class="edit_is_premium">
