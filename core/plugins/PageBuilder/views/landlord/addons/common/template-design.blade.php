                    ...
                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                        <div class="singleTemplates mb-24  wow fadeInUp" data-wow-delay="0.0s">
                            ...
                            <div class="templateDetails">
                                <div class="cap">
                                    <h4><a href="{{$item->url}}" class="templateTittle">{{$item->getTranslation('title',$current_lang)}}</a></h4>
                                    <p class="templateCap">{{$item->getTranslation('description',$current_lang)}}</p>
                                </div>

                                <div class="btn-wrapper mb-20">
                                    <a href="{{ $item->url}}" target="_blank" class="cmn-btn cmn-btns">{{$data['bottom_text']}}</a>
                                </div>
                            </div>
                        </div>
                    </div>
