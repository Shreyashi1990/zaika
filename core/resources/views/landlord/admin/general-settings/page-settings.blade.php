                          ...
                          @csrf
                            ...
                            <div class="form-group  mt-3">
                                ...
                                <select name="job_page" class="form-control">
                                    @foreach($all_home_pages as $page)
                                        <option value="{{$page->id}}" @if($page->id == get_static_option('job_page'))  selected @endif >{{$page->getTranslation('title',get_user_lang())}}</option>
                                    @endforeach
                                </select>
                            </div>
                                ...
                                <div class="form-group  mt-3">
                                    ...
                                    <select name="knowledgebase_page" class="form-control">
                                        @foreach($all_home_pages as $page)
                                            <option value="{{$page->id}}" @if($page->id == get_static_option('knowledgebase_page'))  selected @endif >{{$page->getTranslation('title',get_user_lang())}}</option>
                                        @endforeach
                                    </select>
                                </div>
