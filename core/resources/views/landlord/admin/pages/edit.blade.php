                        ...
                        <div class="col-lg-9">
                            ...
                            <div class="form-group permalink_label" >
                                <label class="text-dark">{{__('Permalink')}} * :
                                    <span id="slug_show" class="display-inline text-info" >{{route('landlord.homepage')}}/{{$page->slug}}</span>
                                    <span id="slug_edit" class="display-inline">
                                         <button class="btn btn-warning btn-sm slug_edit_button"> <i class="mdi mdi-lead-pencil"></i> </button>
                                        <input type="text" name="slug" class="form-control blog_slug mt-2" value="{{$page->slug}}" >
