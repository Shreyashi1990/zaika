...
class TenantDatabaseSeeder extends Seeder
{
    public function run()
    {
        ...
        $dynamic_css_path = 'assets/tenant/frontend/themes/css/dynamic-'.tenant()->id.'-style.css';
        $dynamic_js_path = 'assets/tenant/frontend/themes/js/dynamic-'.tenant()->id.'-script.js';
        ...
        $theme = optional(tenant()->payment_log)->theme ? optional(tenant()->payment_log)->theme : session()->get('theme') ?? 'theme-1'; //for trial theme
