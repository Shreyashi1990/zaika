    ...
    public function handle(TenantRegisterEvent $event)
    {
        ...
        try{
            ...
            if(str_contains($message,'Duplicate entry')){
                if(request()->ajax()){
                    abort(500,__('Tenant database demo data already imoprted'));
                }
                return redirect()->route('landlord.admin.tenant')->with(['msg' => __('Tenant database demo data already imoprted'), 'type'=>'danger']);
            }
