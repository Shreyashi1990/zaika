...
Route::controller(\App\Http\Controllers\Landlord\Frontend\UserDashboardController::class)->middleware(['landlord_glvar','maintenance_mode','tenantMailVerify','setlang'])->name('landlord.')->group(function(){
