...
class PricePlan extends Model
{
    ...
    protected $fillable = ['title','subtitle','features','type','status','price','free_trial','page_permission_feature','blog_permission_feature','product_permission_feature','faq','portfolio_permission_feature'];
