...
return [
    ...
    'migration_parameters' => [
        ...
        '--path' => [
            ...
            database_path('../modules/donation/database/migrations'),
            database_path('../modules/event/database/migrations'),
            database_path('../modules/job/database/migrations'),
            database_path('../modules/knowledgebase/database/migrations'),
        ],
        '--realpath' => true,
    ],
