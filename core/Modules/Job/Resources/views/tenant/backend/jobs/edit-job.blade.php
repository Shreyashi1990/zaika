                                    ...
                                    <div class="form-group permalink_label">
                                        <label class="text-dark">{{__('Permalink / Slug * : ')}}
                                         ...
                                         <button class="btn btn-info btn-sm slug_edit_button px-2 py-1 ml-1"> <i class="las la-edit"></i> </button>
                                          <input type="text" name="slug" value="{{$job->slug}}" class="form-control blog_slug mt-2" >
                                                ...
                                                <div class="card-body">
                                                    <div class="row">
                                                        <div class="col-lg-12">
                                                            ...
                                                            <x-fields.input name="application_fee" extra="application_fee_input" label="{{__('Application Fee')}}" value="{{$job->application_fee}}"/>
