                ...
                <div class="col-xl-8 col-lg-7 col-md-6">
                    <div class="row ">
                        <div class="packageWrapper">
                            ...
                            <form action="{{ route('landlord.frontend.order.payment.form') }}" method="post" enctype="multipart/form-data" class="contact-page-form style-01">
                                @csrf
                                @php
                            ...
                            <div class="col-lg-12 col-md-12 mb-4">
                                <div class="custom_subdomain_wrapper">
                                      <label for=" mb-3">{{__('Add new subdomain')}}</label>
                                      <input class="form-control custom_subdomain input-form2 mt-3" id="custom-subdomain" type="text" autocomplete="off"
                                    ...
                                    <div class="row g-2 theme-row mt-3 row-cols-1 row-cols-xxl-5 row-cols-md-3 row-cols-sm-2">
                                        ...
                                        @if($loop->index < 5)
                                            ...
                                            <div class="col position-relative">
                                                <div class="theme-wrapper {{$loop->first ? 'selected_theme' : ''}}" data-theme="{{$theme->slug}}">
