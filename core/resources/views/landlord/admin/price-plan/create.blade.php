            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="post" action="{{route(route_prefix().'admin.price.plan.create')}}">
                    ...
                    @if(!tenant())
                        ...
                        <div class="row">
                            <div class="form-group ecommerce_data d-none">
                                ...
                                <div class="tab-content" id="myTabContent">
                                    ...
                                    <div class="tab-pane fade show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                                        ...
                                        <x-fields.switcher name="product_simple_search_permission" label="{{__('Enable/Disable Product Simple Search Permission')}}"/>
                                        <x-fields.switcher name="product_advance_search_permission" label="{{__('Enable/Disable Product Advance Search Permission')}}"/>
                                        <x-fields.switcher name="product_duplication_permission" label="{{__('Enable/Disable Product Duplication Permission')}}"/>
                                        <x-fields.switcher name="product_bulk_delete_permission" label="{{__('Enable/Disable Product Bulk Delete Permission')}}"/>
                                    </div>

                                    <div class="tab-pane fade" id="profile-tab-pane" role="tabpanel" aria-labelledby="profile-tab" tabindex="0">
                                        <x-fields.switcher name="inventory_update_product_permission" label="{{__('Enable/Disable Inventory Update Product Permission')}}"/>
                                        <x-fields.switcher name="inventory_simple_search_permission" label="{{__('Enable/Disable Inventory Simple Search Permission')}}"/>
                                        <x-fields.switcher name="inventory_advance_search_permission" label="{{__('Enable/Disable Inventory Advance Search Permission')}}"/>
                                    </div>
