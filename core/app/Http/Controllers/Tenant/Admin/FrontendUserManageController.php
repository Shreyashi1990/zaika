...
class FrontendUserManageController extends Controller
{
    ...
    public function resend_verify_mail(Request $request){
        ...
        $message = __('verify your email to get all news from '). get_static_option('site_'.get_default_language().'_title') . '<div class="btn-wrap"> <a class="anchor-btn" href="' . route('login') . '">' . __('Login') . '</a></div>';
