<div class="general-info-wrapper px-3">
    ...
    <div class="general-info-form mt-0 mt-lg-4">
        <div class="dashboard-input mt-4">
            ...
            <textarea class="form--control summernote radius-10" name="policy_description" placeholder="{{ __("Type Description") }}">{!! isset($product) ? $product?->return_policy?->shipping_return_description : "" !!}</textarea>
        </div>
    </div>
</div>
